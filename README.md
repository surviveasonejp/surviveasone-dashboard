...
VLCC 5隻 + LNG 7隻 + 代替ルート5隻を追跡（日本向けでない船は「日本向けでない」バッジ付きで表示）。全船のIMO番号はMaritimeOptima/VesselFinderで検証済み（2026年4月1日）。
...
| Phase 8 | モデル誠実性・現実連動（3シナリオレンジ、IEA国際比較、現実イベント34件、感度分析、国家石油備蓄基地10基地） | 完了 |
