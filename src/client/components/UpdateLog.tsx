...
const UPDATE_LOG: UpdateEntry[] = [
  {
    date: "2026-07-23",
    description: `石油備蓄 202日に更新（国家103日・民間96日・共同4日）。3/14時点242日から40日分減少・放出の進行を反映`,
    source: "資源エネルギー庁「石油備蓄の状況（推計値の速報）」2026-07-23公表(7/20時点)",
  },
  {
    date: "2026-04-12",
    description: `石油備蓄 229日に更新（国家143日・民間82日・共同4日）。IEA協調放出45日分進行中・5月追加20日分発表反映`,
    source: "資源エネルギー庁 2026-04-08速報(4/5時点)",
  },
  {
    date: "2026-03-23",
