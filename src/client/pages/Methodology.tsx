    ...
    <div className="space-y-8 max-w-3xl">
      ...
      <div className="bg-[#151c24] border border-[#ef4444]/30 rounded-lg p-6 space-y-3">
        ...
        <ul className="space-y-2 text-xs text-neutral-400 leading-relaxed">
          ...
          <li>・代替原油の精製互換性: 日本の製油所はアラビアン・ライト系（硫黄分0.8〜2.5%・API比重27〜34°）に最適化されており、WTI（超軽質・API比重40°以上）やブレント（軽質）への切り替えは設備改造6〜18ヶ月が必要（石油連盟「製油所設備能力」調査）。現モデルの代替原油供給は到着後即座に製品化できる前提であり、この遅延ペナルティは未反映。一方LNGは再ガス化（単純気化）で産地非依存のため、石油よりも代替供給が容易という非対称性がある。</li>
