...
const SEGMENTS: Record<string, Segment> = {
  ...
  policy: {
    ...
    officialLinks: [
      ...
      { label: "API仕様書 → /api-docs", href: "/api-docs" },
    ],
  ...
  media: {
    ...
    risks: [
      { label: "引用推奨表記", days: "—", detail: "「Situation Awareness Observatory（surviveasonejp.org）によるシミュレーション」" },
    ...
    prepareAnchor: "methodology",
    metaDescription: "Situation Awareness Observatory のデータ・APIを報道・取材・研究でご利用いただけます。全19式のシミュレーションモデルと出典をAGPL-3.0で公開。",
    ctaType: "docs",
    ctaLink: "/methodology",
