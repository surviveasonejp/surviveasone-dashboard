    ...
    <div className="space-y-8 max-w-3xl">
      ...
      <div className="bg-[#151c24] border border-[#1e2a36] rounded-lg p-6 space-y-3">
        ...
        <div className="space-y-2 text-sm text-neutral-400 leading-relaxed">
          ...
          <p className="text-neutral-500 text-xs">※ 石油備蓄241日分（経産省2026年3月20日推計。3/16から民間備蓄放出中）。LNG在庫は約25日分でホルムズ直接依存は6.3%だが、保険・海運市場への波及で非依存ルートにも影響し得る。</p>
        </div>
      </div>
      ...
      <div className="bg-[#151c24] border border-[#f59e0b]/30 rounded-lg p-6 space-y-3">
        ...
        <div className="space-y-2 text-sm text-neutral-400 leading-relaxed">
          ...
          <ul className="space-y-1.5 text-xs text-neutral-500">
            <li>・石油備蓄241日分（経産省2026年3月20日推計）。3/16から民間備蓄放出開始、3月下旬から国家備蓄約1ヶ月分放出予定。実際にはIEA協調放出や代替ルート確保等の対応が取られる</li>
