...
//
// ⚠️ 代替調達の前提リスク（2026-04-08 追加注記）:
// 欧州調査会社ケプラーの調査(2025-12〜2026-04)により、マレーシア沖の海上在庫の
// 約8割が中国向け・その供給元の約8割がイラン（ハールク島）と確認された。
// 「非中東」として流通する原油の相当部分が制裁回避を経たイラン産である可能性があり、
// ホルムズ封鎖とイラン制裁強化が同時進行した場合、マレーシア経由の迂回ルートも
// 遮断されるリスクがある。このため nonMiddleEastDailyKL・initialSuccessRate は
// 楽観シナリオでも過大推計になり得る点に留意が必要。
// 出典: 日経ビジネス 2026-04-08 / Kpler
